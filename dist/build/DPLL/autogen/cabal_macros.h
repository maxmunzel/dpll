...
/* package DPLL-1.0 */
#ifndef VERSION_DPLL
#define VERSION_DPLL "1.0"
#endif /* VERSION_DPLL */
#ifndef MIN_VERSION_DPLL
#define MIN_VERSION_DPLL(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_DPLL */
...
#define CURRENT_COMPONENT_ID "DPLL-1.0-1ELpP9auT05D3Gdb6pcs35-DPLL"
